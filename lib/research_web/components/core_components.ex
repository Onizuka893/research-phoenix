defmodule ResearchWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ResearchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ResearchWeb.Gettext, "errors", msg, opts)
    end
  end
